...
export default function SaheebaCaseStudyPage() {
    return (
        <main className="min-h-screen bg-white">
            {/* Top Navigation Bar */}
            <div className="border-b border-zinc-100 bg-white/80 backdrop-blur-md sticky top-16 md:top-20 z-40">
                <div className="section-container py-4 flex items-center justify-between">
                    <Link href="/work" className="inline-flex items-center gap-2 text-zinc-500 hover:text-purple-600 font-medium transition-colors text-sm">
                        <ArrowLeft className="w-4 h-4" />
                        Back to Work
                    </Link>
                    <span className="text-zinc-400 text-sm font-medium">Case Study 02</span>
                </div>
            </div>
