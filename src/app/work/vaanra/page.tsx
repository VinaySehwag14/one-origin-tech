...
import { ArrowRight, ArrowLeft, Layers, Zap, ShoppingCart, TrendingUp } from "lucide-react";
        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="relative pt-12 pb-24 md:pt-20 md:pb-32 overflow-hidden bg-zinc-50">
                ...
                <div className="section-container relative z-10">
                    ...
                    >
                        <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-50 border border-emerald-100 text-emerald-700 font-medium text-sm mb-8">
                        ...
                        <motion.p variants={fadeInUp} className="text-xl md:text-3xl text-zinc-600 mb-12 max-w-3xl mx-auto leading-relaxed font-medium">
                            Global E-commerce Infrastructure built for insane traffic spikes and zero downtime.
                        </motion.p>
                        ...
                        <motion.div variants={fadeInUp} className="grid grid-cols-2 md:grid-cols-4 gap-8 py-10 border-t border-b border-zinc-200 mt-12 text-left">
                            <div>
                                ...
                                <p className="text-zinc-900 font-medium">Full-Stack Dev</p>
                            </div>
                            <div>
                                <h4 className="text-zinc-400 text-xs font-bold uppercase tracking-widest mb-2">Context</h4>
                                <p className="text-zinc-900 font-medium">Headless Build</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p className="text-zinc-900 font-medium">Next.js, Shopify</p>
                            </div>
                        </motion.div>
                    </motion.div>
                </div>
                    ...
                    <div className="grid md:grid-cols-12 gap-12 lg:gap-20">
                        ...
                        >
                            <p className="text-2xl text-zinc-900 font-medium leading-snug">
                                Vaanra approached us with a devastating problem: their monolithic Shopify architecture was buckling under the pressure of their highly successful influencer marketing campaigns.
                            </p>
                            <p>
                                Every time a flash sale dropped, the simultaneous surge of thousands of active checkouts caused severe database locking and API rate limits. Customers were met with slow load times, out-of-sync inventory displaying available items that were actually sold out, and extreme checkout friction.
                            </p>
                            <p>
                                They needed a platform that could immediately absorb massive, instantaneous traffic spikes while providing a fluid, sub-second browsing experience. They didn't just need a redesign; they needed enterprise-grade, decoupling engineering.
                            </p>
                        </motion.div>
                    </div>
                </div>
