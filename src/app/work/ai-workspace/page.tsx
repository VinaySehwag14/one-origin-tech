        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="relative pt-12 pb-24 md:pt-20 md:pb-32 overflow-hidden bg-zinc-50">
                ...
                <div className="section-container relative z-10">
                    ...
                    >
                        <Link href="/work" className="inline-flex items-center gap-2 text-zinc-500 hover:text-amber-600 font-medium transition-colors text-sm group">
                            <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
                            Back to Work
                        </Link>
                        <span className="text-zinc-400 text-xs font-bold tracking-widest uppercase">Case Study 03</span>
                    </motion.div>
